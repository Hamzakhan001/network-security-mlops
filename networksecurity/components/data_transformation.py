...
class DataTransformation:
    ...
    def get_data_transformer_object(cls) -> Pipeline:
        """
        It initializes a  KNN imputer object with parameters specified in a training_pipeline.py file and returns a pipeline object with
        ...
        """
        logging.info("get trasnformer object")
